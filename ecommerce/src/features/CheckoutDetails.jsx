...
import { store_shippingAddress } from '../redux/checkoutSlice';
    ...
    <div className="row shadow p-2">
        ...
        <div class="mb-3">
                    ...
                    <CountrySelect
                     onChange={(e) => {
                        setCountryid(e.id);
                        setShippingAddress({...shippingAddress,country:e.name})
                     }}
        ...
        <div className="row">
                <div class="mb-3 col-6">
                    ...
                    <StateSelect
                     ...
                     onChange={(e) => {
                        setstateid(e.id);
                        setShippingAddress({...shippingAddress,state:e.name})
                     }}
                 ...
                 <div class="mb-3 col-6">
                    ...
                    <CitySelect
                        ...
                        stateid={stateid}
                        onChange={(e) => {
                           setShippingAddress({...shippingAddress,city:e.name})
                        }}
